...
export class AskView extends LitElement {
    ...
    connectedCallback() {
        ...
        if (window.api) {
            ...
            this.onScrollUpCb = () => this.handleScroll('up');
            this.onScrollDownCb = () => this.handleScroll('down');
            this.onAskStateUpdateCb = (event, newState) => {
            ...
            window.api.askView.onShowTextInput(this.onShowTextInputCb);
            window.api.askView.onScrollResponseUp(this.onScrollUpCb);
            window.api.askView.onScrollResponseDown(this.onScrollDownCb);
            window.api.askView.onAskStateUpdate(this.onAskStateUpdateCb);
    ...
    disconnectedCallback() {
        ...
        if (window.api) {
            if (this.onAskStateUpdateCb) window.api.askView.removeOnAskStateUpdate(this.onAskStateUpdateCb);
            if (this.onShowTextInputCb) window.api.askView.removeOnShowTextInput(this.onShowTextInputCb);
            if (this.onScrollUpCb) window.api.askView.removeOnScrollResponseUp(this.onScrollUpCb);
            if (this.onScrollDownCb) window.api.askView.removeOnScrollResponseDown(this.onScrollDownCb);
